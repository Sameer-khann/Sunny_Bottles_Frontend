...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-[88px] bg-[#FDF2D3] px-6   flex items-center justify-between top-0 z-50 relative">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <ul className="absolute top-[88px] left-0 w-full bg-[#FDF2D3] flex flex-col items-center md:hidden shadow-lg py-4 space-y-4 text-gray-700 font-medium z-50">
          <li>
